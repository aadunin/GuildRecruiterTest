...
-- Фичи: перехват SendChatMessage (без спама), прогресс-бар, Summary, SKIP
...
-- Прогресс по сьютам (точный), по кейсам — индикативно
...
SlashCmdList["GRUTEST"] = function(msg)
  ...
  elseif cmd == "list" then
    ...
    cinfo("Usage: /grutest run [filter] | list")
  end
end
